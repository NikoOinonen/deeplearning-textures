...
params = [18, 25, 36, 72, 68, 0.3, 0.05]
...
constructor = SeqConstructor(data_path, dataset='minc', img_size=img_size, batch_size=batch_size, split=split, augmentations=augmentations, normalize=normalize)
